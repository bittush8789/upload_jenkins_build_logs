...
This project automates the collection of Jenkins job build logs from a Linux-based Jenkins server and uploads them daily to Amazon S3 using Bash scripting and AWS CLI. It helps in centralized log storage, faster troubleshooting, and improved CI/CD monitoring.
